...
// console.log(smol.geetele()) რადგან დაფარულია მაგიტომაც გამოვიდა ესე ხოლო მის ადგილზე თავიდან undefineds წერს
//რადგან  return `${this.#cxo10}` დაფარულია და არ არის ხელმისაწვდომი შემდეგ კი console.log(smol.geetele()) როდესაც
//აქ ვიძახებთ ჩნდება მისი მნიშვნელობით რომელიც  აქ"mgeli", "vefxvi", "lomi", "gepardi", "mgelDzagla"მივანიჭეთ
//როდესაც # ვიყენებთ ეს ნიშნავს რომ დაფარულია მნაცემმები და მისი გატანა არ შეიძლეაბ ასევე როდეაც this არ ვიყენებთ
//და ისე ვქნმით მონაცემესბ ის მონაცემები საჯაროა ამიტომაც This ით ჩვენ მხოლოდ კლასისი შიგნით უნდა გავხადოთ
//ხელმისაწვდომი.
